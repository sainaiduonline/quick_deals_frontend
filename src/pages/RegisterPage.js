...
const RegisterPage = () => {
  const [userData, setUserData] = useState({
    ...
    password: '',
    confirmPassword: '',
    userType: 'consumer' // 'consumer' or 'business'
  });
  ...
  const handleSubmit = (e) => {
    ...
    // Registration logic would go here (API call, etc.)
            ...
            <div className="user-type-options">
              <label>
                <input 
                  ...
                  name="userType" 
                  value="consumer" 
                  checked={userData.userType === 'consumer'} 
                  onChange={handleChange} 
                />
                Consumer
              </label>
              <label>
                <input 
                  ...
                  name="userType" 
                  value="business" 
                  checked={userData.userType === 'business'} 
                  onChange={handleChange} 
                />
                Business
              </label>
